(function () {
  ...
  const translations = {
    "zh-CN": {
      ...
      "index.heroSub": "一个接入 30,000 首真实曲目、CultureMERT embedding 与 DCAS 推荐主线的跨文化音乐工作台。",
      "index.action.start": "开始使用",
      ...
      "settings.generalCopy": "这里调整 Echo 的界面语言、AI 回复语言与专辑封面的视觉呈现方式。",
    ...
    en: {
      ...
      "index.heroSub": "A cross-cultural music workbench connected to a 30,000-track catalog, CultureMERT embeddings, and the DCAS recommendation pipeline.",
      "index.action.start": "Start",
      ...
      "settings.generalCopy": "Adjust Echo's interface language, AI reply language, and album-cover appearance.",
