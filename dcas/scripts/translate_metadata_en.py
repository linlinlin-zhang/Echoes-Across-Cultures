...
PHRASE_MAP = {
    ...
    "吉他琶音": "guitar arpeggios",
    "吉他音墙": "guitar wall of sound",
    "双吉他": "dual guitars",
    "吉他": "guitar",
    "贝斯": "bass",
    "贝斯线": "bass line",
    ...
    "高亢嗓音": "soaring voice",
    "沙哑嗓音": "raspy voice",
    "清澈嗓音": "crystalline voice",
    "浑厚嗓音": "rich voice",
    "温柔嗓音": "tender voice",
    "甜美嗓音": "sweet voice",
    "爆发力十足": "explosive",
    "极具穿透力": "highly penetrating",
    # --- 风格/流派形容 ---
    "摇滚": "rock",
    "流行": "pop",
    "民谣": "folk",
    ...
    "勇气": "courage",
    "宁静安详": "peaceful",
    "安宁静谧": "serene and quiet",
    "松弛": "relaxed",
    "轻松": "easy",
    "紧绷": "taut",
    "紧张": "tense",
    "躁动不安": "restless unease",
    "阴郁": "brooding",
    "苍凉": "bleak",
    "苍穹": "sky",
    "末世": "apocalyptic",
    ...
    "深夜驾车": "late-night drives",
    "深夜独酌": "late-night drinks alone",
    "深夜独行": "late-night walks",
    "深夜疾驰": "late-night sprints",
    "深夜公路": "late-night highway",
    "深夜": "late night",
    "独处": "solitude",
    "独酌": "solo drink",
    "午后": "afternoon",
    ...
    "公路巡航": "highway cruising",
    "公路远行": "long road trips",
    "公路": "highway",
    "驾车": "driving",
    "自驾": "solo drive",
    "通勤": "commute",
    ...
    "尾奏": "outro",
    "和弦": "chords",
    "分解和弦": "arpeggiated chords",
    "琶音": "arpeggios",
    "riff": "riff",
    "四拍鼓点": "four-on-the-floor beat",
    "鼓点": "drums",
    "节拍": "beat",
    "节奏": "rhythm",
    "律动": "groove",
    ...
    "像": "like",
    "宛如": "as if",
    "交织着": "intertwined with",
    "伴随": "accompanied by",
    "搭配": "paired with",
    "融合": "blending",
    "碰撞": "collide",
    "碰撞出": "collide to create",
    "蜕变成": "transform into",
    "转化为": "transform into",
    ...
    "毫不妥协": "uncompromising",
    # --- 比喻/意象 ---
    "如月光洒落": "like moonlight falling",
    "如流水般": "like flowing water",
    "如暗潮涌动": "like dark tides surging",
    "如风暴般": "like a storm",
    "如钢铁巨兽": "like an iron beast",
    "如战鼓般": "like war drums",
    "如维京战船": "like a Viking longship",
    "如飞鸟挣脱": "like a bird breaking free",
    "如梭鱼般": "like barracuda",
    "如午夜酒吧": "like a midnight bar",
    "如海风轻拂": "like a sea breeze",
    "如电光撕裂": "like lightning tearing through",
    "如战旗高扬": "like a battle flag soaring",
    "如微风拂过": "like a breeze brushing",
    "如午后阳光": "like afternoon sunlight",
    "如星空般": "like a starlit sky",
    ...
    "劈开空气": "tears through the air",
    "劈开夜幕": "tears through the night",
    "劈开人群": "splits the crowd",
    "撕裂沉寂": "tears through the silence",
    "撕裂寂静": "shatters the silence",
    "撕裂音墙": "tears through the wall of sound",
    "撕裂出": "tears open",
    "撕裂夜空": "tears through the night sky",
    "点燃全场": "ignites the room",
    "点燃热血": "ignites passion",
    "引爆": "ignite",
    "引爆万人齐唱": "ignites mass sing-alongs",
    "失控": "out of control",
    "失控的火焰": "an out-of-control flame",
    "狂欢": "carnival",
    "狂欢宣言": "carnival manifesto",
    ...
    "重生": "rebirth",
    "余温": "afterglow",
    "余韵": "lingering resonance",
    "回响": "echo",
    "共鸣": "resonance",
    "共振": "resonance",
    "诗意": "poetic",
    "诗意想象": "poetic imagination",
    "质朴诗意": "earthy poetry",
    "隽永笔触": "timeless touch",
    "从容笔触": "unhurried touch",
    "松弛气息": "laid-back spirit",
    "温暖底色": "warm undertone",
    "粗犷能量": "raw energy",
    "原始张力": "raw tension",
    "原始能量": "raw energy",
    "复古情调": "retro charm",
    "都市感": "urban sophistication",
    "浪漫律动": "romantic groove",
    "浪漫余温": "romantic afterglow",
    "夜空气息": "nocturnal energy",
    "夜曲": "nocturne",
    "夏日气泡水": "summer soda",
    "清爽活力": "effervescent freshness",
    "热带风情": "tropical vibe",
    "阳光海滩": "sunny beach",
    "海滩般的松弛氛围": "laid-back beach vibe",
    "慵懒律动": "languid groove",
    "慵懒阳光": "laid-back sunshine",
    "慵懒吟唱": "laid-back vocals",
    "松弛氛围": "relaxed atmosphere",
    "安详氛围": "peaceful atmosphere",
    "宁静氛围": "serene atmosphere",
    "复古迪斯科": "retro disco",
    "复古合成器": "retro synth",
    "复古摇滚": "retro rock",
    "复古失真": "retro distortion",
    "加州风情": "California vibes",
    "加州摇滚": "California rock",
    "民谣摇滚": "folk rock",
    "民谣流行": "folk pop",
    "体育场摇滚": "arena rock",
    "车库轰鸣": "garage roar",
    "吉他摇滚": "guitar rock",
    "太空般": "cosmic",
    "太空般的辽阔音场": "vast, cosmic soundscape",
    "霓虹倒影": "neon reflections",
    "霓虹下的浪漫": "romantic neon glow",
    "霓虹街道": "neon-lit streets",
    "霓虹公路": "neon highway",
    "城市灯火": "city lights",
    "城市霓虹": "city neon",
    "都市夜晚": "urban nights",
    "都市霓虹": "urban neon",
    "夜晚的孤独": "nighttime loneliness",
    "深夜的脉动": "late-night pulse",
    ...
    "转音": "inflections",
    "即兴": "improvised",
    "即兴段落": "improvised passages",
    "即兴演奏": "improvisation",
    "漂流": "drift",
    "异色": "vivid",
    "异色梦境": "vivid dreamscape",
    "末世图景": "apocalyptic landscape",
    "冷冽的末世图景": "cold apocalyptic landscape",
    "数字时代": "digital age",
    "机械律动": "mechanical rhythm",
    ...
    "正是": "is exactly",
    "正是这首曲子的天然舞台": "is this song's natural stage",
    "带着": "carrying",
    "带着一丝": "with a hint of",
    ...
    "时刻": "moment",
    "瞬间": "instant",
    "之间找到": "finding between",
    "找到": "find",
    "恰到好处": "just right",
    "恰到好处的平衡": "just the right balance",
    "平衡": "balance",
    ...
    "与众不同": "distinctive",
    "淋漓尽致": "to the fullest",
    "浑然天成": "naturally formed",
    "美轮美奂": "stunning",
    "引人入胜": "captivating",
    "扣人心弦": "gripping",
    "动人心弦": "moving",
    "回味无穷": "lingering",
    "余音绕梁": "lingering resonance",
    "沁人心脾": "refreshing",
    "心旷神怡": "uplifting",
    "如痴如醉": "entranced",
    "如梦如幻": "dreamlike",
...
def semantic_translate(sentence):
    ...
    if has_era:
        ...
        for zh, en in era_map:
            if zh in sentence:
                parts.append(
                    f"from the {en}" if not en.startswith(("contemporary", "retro", "classic", "traditional")) else en
                )
                break
    ...
    if has_scene:
        scenes = []
        scene_map = [
            ("深夜", "late-night listening"),
            ("午后", "afternoon relaxation"),
            ("黄昏", "dusk drives"),
            ("清晨", "early morning"),
            ("夜晚", "nighttime"),
            ("独处", "solitude"),
...
def main():
    ...
    parser.add_argument(
        "--dry-run",
        action="store_true",
        help="Only show sample translations, do not modify CSV",
    )
